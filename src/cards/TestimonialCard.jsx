...
export default function TestimonialCard({ testimonial }) {
    return <button type="button" target='_blank' className='w-[calc(50%-57px)] rounded-sm flex-col p-4 border carousel-item shadow-lg bg-[#f5f5f5] text-black'>
        ...
        <div className='mt-2'>
            ...
            <div className='flex items-center mx-auto mt-2 gap-x-2 w-fit'>
                {
