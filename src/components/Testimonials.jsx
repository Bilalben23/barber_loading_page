    ...
    return (
        <div className='mt-20 w-[95%] md:w-[90%] lg:[w-[85%] mx-auto flex-col md:flex-row flex gap-x-5'>
            <div className='p-2 md:w-2/5'>
                <h5 className='mb-2 text-sm text-error'>Testimonials</h5>
                <p className='mb-2 text-2xl font-semibold md:text-3xl lg:text-4xl'>What Our Clients Say About Us</p>
                <p className='mb-6 opacity-60'>Let your hairdressers do their amazing job. Trim the hair to get your desired look. Book appointment with us for your favorite hair Styles!</p>
