...
export default function AboutUs() {
    return (
        <div id="about" className='w-[90%] md:w-[80%] mx-auto flex flex-col-reverse md:flex-row gap-x-20 items-center'>
            <div className='w-full mt-5 md:mt-0 md:w-auto'>
                <img src={img4} alt="barber" className='w-full h-full' />
            </div>
            <div className='w-full md:w-1/2'>
                <h2 className='mb-2 font-semibold text-error'>About us</h2>
